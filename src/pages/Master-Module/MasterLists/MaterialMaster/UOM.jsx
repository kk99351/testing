...
const UnitOfMesurement = () => {
  const demoData = [
    { uom_name: "Group A", uom_code: "A001" },
    { uom_name: "group d", uom_code: "B001" },
    { uom_name: "Group C", uom_code: "C001"},
    { uom_name: "Group D", uom_code: "D001" },
    { uom_name: "Group E", uom_code: "E001" },
  ];
...
export default UnitOfMesurement;
