...
const TermsAndConditions = () => {
  const demoData = [
    { slno: 1, termAndCond: "Group A",fileName:"99.09%" },
    { slno: 2, termAndCond: "group d",fileName:"99.09%" },
    { slno: 3, termAndCond: "Group C",fileName:"99.09%"},
    { slno: 4, termAndCond: "Group D",fileName:"99.09%" },
    { slno: 5, termAndCond: "Group E",fileName:"99.09%" },
  ];
                        ...
                        <tr key={row.id} {...row.getRowProps()}>
                          {row.cells.map(cell => (
                            <td key={cell.column.id} {...cell.getCellProps()}>
                              {cell.column.id !== "id"
                                ?  <Link to={`/modify_terms_and_conditions/${row.original.id}`}>
                                     {cell.render("Cell")}
                                   </Link>
                                : cell.render("Cell")}
                            </td>
