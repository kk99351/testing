...
const PaymentMethod = () => {
  const demoData = [
    { mtName: "Group A", mtCode: "A001" },
    { mtName: "group d", mtCode: "B001" },
    { mtName: "Group C", mtCode: "C001"},
    { mtName: "Group D", mtCode: "D001" },
    { mtName: "Group E", mtCode: "E001" },
  ];
            ...
            <div className="col-sm-7">
              <div className="text-sm-end">
                <button
                  ...
                  onClick={() => navigate("/create_payment_method")}
                >
                        ...
                        <tr key={row.id} {...row.getRowProps()}>
                          {row.cells.map(cell => (
                            <td key={cell.column.id} {...cell.getCellProps()}>
                              {cell.column.id !== "id"
                                ?  <Link to={`/modify_Payment_method/${row.original.id}`}>
                                     {cell.render("Cell")}
                                   </Link>
                                : cell.render("Cell")}
                            </td>
