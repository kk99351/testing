...
const BankMaster = () => {
  const demoData = [
    { slno: 1, bankName: "Group A" },
    { slno: 2, bankName: "group d" },
    { slno: 3, bankName: "Group C"},
    { slno: 4, bankName: "Group D" },
    { slno: 5, bankName: "Group E" },
  ];
            ...
            <div className="col-sm-7">
              <div className="text-sm-end">
                <button
                  ...
                  onClick={() => navigate("/create_bank_master")}
                >
                        ...
                        <tr key={row.id} {...row.getRowProps()}>
                          {row.cells.map(cell => (
                            <td key={cell.column.id} {...cell.getCellProps()}>
                              {cell.column.id !== "id"
                                ?  <Link to={`/modify_bank_master/${row.original.id}`}>
                                     {cell.render("Cell")}
                                   </Link>
                                : cell.render("Cell")}
                            </td>
