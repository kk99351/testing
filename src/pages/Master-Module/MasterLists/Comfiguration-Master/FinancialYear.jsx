...
const FinancialYear = () => {
  const demoData = [
    {
      ...
      halfstDate: "Info 4",
      halfendDate: "jkhjhgy",
      secStDate: "19-39-2382",
      secEndDate: "34-343-1133",
      current: "current",
    },
    {
      stDate: "Jane Smith",
  ...
  const secondTableColumns = useMemo(
    () => [
      ...
      {
        Header: "PARENT SECOND HALF YEAR",
        columns: [
          {
            Header: "START DATE",
            accessor: "secStDate",
                    ...
                    <div className="position-relative">
                      <label htmlFor="search-bar-1" className="search-label">
                        ...
                        <input
                          ...
                          onChange={e => setSecondGlobalFilter(e.target.value)}
                        />
                        <i className="bx bx-search-alt search-icon"></i>
                      </label>
                    </div>
