...
const ClientWiseReportview = () => {
  ...
  const exportToExcel = () => {
    ...
    const formattedData = responseData.map(item => ({
      ...
      "ASSET REF.NO": item.ref_no,
      "DIVICE STATUS": item.device_status, 
      ...
      "ASSET VERIFICATION": item.asset_ver
    }));
          ...
          <Card>
            <CardHeader>
              <h1 className="card-title" style={{ fontSize: "20px" }}>
                GENERATED CLIENT WISE REPORT DETAILS{" "}
              </h1>
            </CardHeader>
              ...
              <div className="col-md-3">
                ...
                <div className="col-md-7">
                  <div className="d-flex justify-content-end">
                    ...
                    <Button
                      className="btn btn-secondary-subtle border border-secondary"
                      onClick={() => navigate("/client_wise_report")}
                      style={{
                        paddingTop: "5px",
                        width: "80px",
                        height: "37px",
...
export default ClientWiseReportview;
