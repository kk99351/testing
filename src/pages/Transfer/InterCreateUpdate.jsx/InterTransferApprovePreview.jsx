                ...
                <div className="col-sm-7 mb-2">
                  <div className="text-sm-end">
                    ...
                    <Button
                      ...
                      onClick={() => navigate("/inter_transfer_approval")}
                      style={{
                        paddingTop: "5px",
                        width: "80px",
                        height: "35px",
...
InterTransferApprovePreview.propTypes = {
  row: PropTypes.object, 
};

InterTransferApprovePreview.defaultProps = {
  row: {}, 
};

export default InterTransferApprovePreview;
