...
const InterRecieveAssetsPreview = () => {
                  ...
                  <div className="col-sm-7 mb-2">
                    <div className="text-sm-end">
                      ...
                      <Button
                        ...
                        onClick={() => navigate("/inter_recieve_assets")}
                        style={{
                          paddingTop: "5px",
                          width: "80px",
                          height: "35px",
...
InterRecieveAssetsPreview.propTypes = {
  row: PropTypes.object, // Add prop validation for row object
};

InterRecieveAssetsPreview.defaultProps = {
  row: {}, // Set default value for row object
};

export default InterRecieveAssetsPreview;
