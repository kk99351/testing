...
//                         onClick={() => navigate("/intra_recieve_assets")}
//                         style={{
//                           paddingTop: "5px",
//                           width: "80px",
//                           height: "35px",
...
//                         RECIEVE DATE <font color="red">*</font>
//                       </Label>
//                       <Input
//                         type="date"
//                         name="companygroup"
...
// RecieveAssetPreview.propTypes = {
//   row: PropTypes.object,
// };

// RecieveAssetPreview.defaultProps = {
//   row: {},
// };

// export default RecieveAssetPreview;
import React, { useMemo, useEffect, useState } from "react";
import {
  Button,
  Col,
                  ...
                  <form className="needs-validation" noValidate>
                    <Row className="mb-2">
                      <Col md={12}>
                        ...
                        />
                        <span className="text-danger">{errors.rDate}</span>
                      </Col>
